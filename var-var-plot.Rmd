...
author: "Jon Meek - Trenton R Users - 18 July 2020"
...
* You have a data frame with more than two colums that you want to plot.
...
##   note: when running this as a .Rmd file you may have to type 'q' to get past the data load

library(dplyr)
library(ggplot2)
library(ggpubr) # Align plot grids
...
penguinPlots2 <- genPlot(penguins,'Palmer Penguins', vars_to_plot_x, vars_to_plot_y, axis_labels_x, axis_labels_y, 'sex')
ggarrange(plotlist = penguinPlots2, ncol = 1, nrow = length(penguinPlots2), align = "v")
...
* ggplot objects "may be" rendered only at print time
    ...
    + This will result in the expected labels but only the last defined data set
